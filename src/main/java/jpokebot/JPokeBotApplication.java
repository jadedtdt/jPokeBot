...
public class JPokeBotApplication extends ListenerAdapter
{
	/**
	 * These are our possible commands our bot will recognize.
	 *
	 */
    ...
    {
    	//We create our instance variable of our Bot account
    	JPokeBot myBot = new JPokeBot();
        ...
        try
        {
			JDA jda = new JDABuilder(AccountType.BOT)
                    .setToken(myBot.getToken())           			//The token of the account that is logging in.
                    .addEventListener(new JPokeBotApplication())  	//An instance of a class that will handle events.
    ...
    public void onMessageReceived(MessageReceivedEvent event)
    {
        ...
        System.out.println(Config.PREFIX + Commands.catch_.toString());
        if (msg.equalsIgnoreCase(Config.PREFIX + Commands.roll.toString()))
        {
        ...
        else if (msg.equalsIgnoreCase(Config.PREFIX + Commands.catch_.toString()))
        {
            //In this case, we have an example showing how to use the Success consumer for a RestAction. The Success consumer
            // will provide you with the object that results after you execute your RestAction. As a note, not all RestActions
            // have object returns and will instead have Void returns. You can still use the success consumer to determine when
            ...
            Random rand = new Random();
            int roll = rand.nextInt(pokemon.size()) + 1; //This results in 1 - 6 (instead of 0 - 5)
            channel.sendMessage("Your roll: " + roll).queue();
            channel.sendMessage("This is the pokemon: " + pokemon.get(roll)).queue();
            channel.sendMessage("https://play.pokemonshowdown.com/sprites/xyani/" + pokemon.get(roll) + ".gif").queue();
        }
        else if (msg.equalsIgnoreCase(Config.PREFIX + Commands.block.toString()))
        {
